...
import { FortuneCookieExtension } from "./FortuneCookieExtension";
import { PlayerInventoryExtension } from "./PlayerInventoryExtension";
...
export class ExtensionLoader {
    ...
    constructor(param: ExtensionLoaderParameter) {
        this.registeredExtensions = [
            ...
            new FortuneCookieExtension(),
            //new PlayerInventoryExtension()
        ];
    }
